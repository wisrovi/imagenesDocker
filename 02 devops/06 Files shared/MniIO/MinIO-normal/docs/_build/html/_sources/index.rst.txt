...
- `DVC Documentation <https://dvc.org/doc>`_
- `Docker Compose Documentation <https://docs.docker.com/compose/>`_

Author
------

This documentation and project setup was created by `Wisrovi Rodriguez <https://es.linkedin.com/in/wisrovi-rodriguez>`_.
