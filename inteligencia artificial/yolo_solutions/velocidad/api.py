...
def create_solution(model_path_arg, fps_arg):
    ...
    speedestimator = solutions.SpeedEstimator(
        model=model_path_arg,  # Pasa la ruta del modelo aquí
        fps=fps_arg,
        # Puedes exponer estos parámetros en la interfaz de Gradio si lo deseas
        # max_speed=120,
        # max_hist=5,
...
with gr.Blocks(title="Estimación de Velocidad de Objetos en Video") as interface:
    gr.Markdown(
        """
        # 🏎️ **Estimación de Velocidad de Objetos en Video** 🚀
        Sube un archivo de video para detectar objetos y estimar su velocidad.
        """
    )
