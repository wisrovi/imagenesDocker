...
def create_solution(model_path_arg, fps_arg, width=1080, height=720):
    """
    ...
    regioncounter = solutions.RegionCounter(
        ...
        model=model_path_arg,  # model for counting in regions i.e yolo11s.pt
    )
...
with gr.Blocks(title="Conteo de Objetos en Video") as interface:
    gr.Markdown(
        """
        # 🏎️ **Conteo de Objetos en Video** 🚀
        Sube un archivo de video para detectar objetos y contar su número.
        """
    )
