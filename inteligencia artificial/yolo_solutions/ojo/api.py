...
def create_solution(model_path_arg, fps_arg):
    ...
    visioneye = solutions.VisionEye(
        ...
        model=model_path_arg,  # use any model that Ultralytics support, i.e, YOLOv10
...
with gr.Blocks(title="Demostración de Visión en Tiempo Real VisionEye") as interface:
    gr.Markdown(
        """
        # 👁️ **Visión en Tiempo Real con VisionEye** 🚀
        Sube un archivo de video para ver cómo VisionEye detecta y rastrea objetos.
        """
    )
